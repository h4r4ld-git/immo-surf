    ...
    <div id="aff${val._id}" style="width:65%; float:right; display:none;">
      ...
      <div class="field is-horizontal">
        ...
        <div class="field-body">
          <div class="field">
            <p class="control">
              <input name="immob" id="${val._id}immob1" class="input" placeholder="WHAT?" value="${val.title}" required>
            </p>
          </div>
        </div>
      </div>
      <div class="field is-horizontal">
        ...
        <div class="field-body">
          <div class="field">
            <p class="control">
              <textarea maxlength="847" name="descr" id="${val._id}descr15" class="textarea" placeholder="Description | Beschrijving" required>${val.description}</textarea>
            </p>
          </div>
        </div>
      </div>
      <div class="field is-horizontal">
        ...
        <div class="field-body">
          <div class="field">
            <p class="control">
              <input type="text" name="descr0" id="${val._id}descr01" class="input" placeholder="€" value="${val.prix}" required>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="modal-card">
        ...
        <section class="modal-card-body">
          ...
          <div class="field">
            ...
            <div class="control">
              <textarea name="description" class="textarea" type="textarea" placeholder="Description de l'affiche" required></textarea>
            </div>
          </div>
          <div class="field">
            <label class="label">Prix</label>
            <div class="control">
              <input name="prix" class="input" type="input" placeholder="Prix de l'affiche" required>
            </div>
          </div>
          <div class="field">
            <label class="label">Tel</label>
            <div class="control">
              <input name="tel" class="input" type="input" placeholder="Tel de l'affiche" required>
            </div>
          </div>
          <div class="field">
            <label class="label">Mail</label>
            <div class="control">
              <input name="mail" class="input" type="input" placeholder="Mail de l'affiche" required>
            </div>
          </div>
          <div class="field">
            <label class="label">Adresse</label>
            <div class="control">
              <input name="addr" id="addrSub" type="search" placeholder="Adresse de l'affiche" class="pac-target-input input" autocomplete="off" required>
            </div>
          </div>
        </section>
