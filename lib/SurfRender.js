...
function getAbonnementName(user, abonnement){
  var ret = `
  <div class="select is-5">
    <select name="newAbonnement" id="${user._id.toString()}NewAbonnement" required>`;
  if (!abonnement){
    ret += `
    ...
    ret += `
      ...
      <option value="OnePlus" selected>One+</option>
      <option value="Limitless">Limitless</option>
    `
    ...
    ret += `
      <option value="One">One</option>
      <option value="OnePlus">One+</option>
      <option value="Limitless" selected>Limitless</option>
    `
  }
  ret += `
    </select>
        ...
        <div class="profiles-container-head">
          ...
          <div class="field is-horizontal">
            ...
            <div class="field-body">
              <div class="field">
                <p class="control">
                  ${getAbonnementName(user, abonnement)}
                </p>
              </div>
            </div>
          </div>
          <button id="editUser" type="button" name="button">Edit</button>
        </div>
      </div>
